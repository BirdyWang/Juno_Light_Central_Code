...
nrfutil settings generate --family NRF52 --application ble_hand_central.hex --application-version 1 --bootloader-version 1 --bl-settings-version 1 bootloader_setting.hex
...
nrfjprog -f nrf52 --program ble_hand_central.hex
:: verify that the application is programmed correctly
nrfjprog --verify ble_hand_central.hex
